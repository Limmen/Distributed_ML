...
def main():
    ...
    cluster = TFCluster.run(sc, har_dist_model.map_fun, args, args.cluster_size, num_ps, args.tensorboard, TFCluster.InputMode.SPARK, log_dir=args.model)
    if args.mode == "train":
